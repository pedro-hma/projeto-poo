...
public class Jogo {
    ...
    public void iniciar() {
        ...
        // Loop para permitir o jogador "Puxar" ou "Parar"
        ...
        // Verifica o resultado e ajusta o saldo do jogador
   ...
   // }
    ...
    private void finalizarPartida(double aposta) {
       ...
       // } else if (pontuacaoJogador < pontuacaoDealer) {
            ...
            contaJogador.ganharAposta(aposta); // Devolve a aposta
